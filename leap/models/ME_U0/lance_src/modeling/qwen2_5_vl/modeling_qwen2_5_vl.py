...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen2_5_VLConfig, device=None):
        ...
        if self.rope_type in ROPE_INIT_FUNCTIONS:
            ...
            # transformers>=5.0 removed the "default" entry (lance_vla shim; same
            # fix as Qwen2RotaryEmbedding). Needed once mrope is actually enabled.
            from leap.models.ME_U0.lance_src.modeling.qwen2.modeling_qwen2 import (
                _lance_default_rope_init,
            )
